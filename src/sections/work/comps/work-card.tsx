  ...
  return (
    <article className="group overflow-hidden rounded-lg border border-border bg-primary-muted">
      <div className="relative flex h-60 items-center justify-center overflow-hidden bg-muted">
        ...
        <span className="relative font-label text-lg tracking-[0.11em] text-primary transition-transform duration-300 group-hover:scale-105">
          {thumbnailLabel}
        </span>
      </div>
      <div className="flex flex-col items-start gap-2 p-5">
        <p className="font-mono text-[0.6875rem] tracking-[0.16em] text-primary">{tag}</p>
        <h3 className="font-display text-xl tracking-[0.025em] text-foreground">{name}</h3>
      </div>
    </article>
  )
}
